...
export class Backend implements backendInterface {
    ...
    async getAllDiseases(): Promise<Array<DiseaseInfo>> {
        if (this.processError) {
            try {
    ...
    async getDetectionHistory(): Promise<Array<DetectionRecord>> {
        if (this.processError) {
            try {
    ...
    async getDiseaseInfo(arg0: string): Promise<DiseaseInfo> {
        if (this.processError) {
            try {
                const result = await this.actor.getDiseaseInfo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getModelMetrics(): Promise<Array<ModelMetrics>> {
        if (this.processError) {
            try {
    ...
    async saveDetection(arg0: string, arg1: string, arg2: number, arg3: string, arg4: string): Promise<DetectionID> {
        if (this.processError) {
            try {
                const result = await this.actor.saveDetection(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
